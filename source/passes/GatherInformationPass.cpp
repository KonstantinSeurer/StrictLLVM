...
void GatherInformationPass::GatherInformation(BuildContext& context, Module* module, Ref<Unit> unit)
{
...
PassResultFlags GatherInformationPass::Run(PrintFunction print, BuildContext& context)
{
	for (auto module : context.GetModules())
	{
		...
		{
			GatherInformation(context, module.get(), unit);
		}
	}
